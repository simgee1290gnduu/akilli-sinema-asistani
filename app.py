...
# ==============================================================================
st.markdown(f"""
    <div style='background: linear-gradient(90deg, #514a9d 0%, #24c6dc 100%); padding: 20px; border-radius: 10px; text-align: center; box-shadow: 0px 4px 15px rgba(0,0,0,0.3);'>
        <h2 style='margin:0; color:white;'>🎬 Akıllı Sinema İçerik Öneri Asistanı</h2>
        <p style='margin:5px 0 0 0; color:#f0f0f0; font-size:14px;'>Bulanık mantık tabanlı sinematik içerik analiz ve reaktif uygunluk değerlendirmesi</p>
    </div>
""", unsafe_allow_html=True)
